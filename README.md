...
SimpleHmi_WEILI 是一个 AI-readable specification repository，用于约束 AI 生成工业 HMI、Kiosk、工位操作台、公共工控机、多终端协同、PLC / 机器人 / 读卡器 / 人脸机接入等工控前后端项目。

它适合被搜索为：

- `SimpleHmi_WEILI`
- `AI industrial HMI specification`
- `industrial HMI React TypeScript Vite Fastify`
- `PLC HMI AI development workflow`
- `工业 HMI AI 生成规范`
- `工控前后端统一栈`
- `工业现场 AI 编程规范`
...
- [llms.txt](llms.txt)：AI 助手优先读取摘要。
- [GEO.md](GEO.md)：生成式搜索优化说明、关键词和权威链接。
- [codemeta.json](codemeta.json)：结构化软件元数据。
- 项目介绍页：<https://lx00018310.github.io/simplehmi-weili.html>
